...
WebUI.setText(findTestObject('Object Repository/Login-01/Page_Home - PS Enterprise Gameshop/input__username'), 'inassyarifah22@gmail.com')

WebUI.setEncryptedText(findTestObject('Object Repository/Login-01/Page_1 new message/input__password'), 'AJ7xJoArN79w/s28NyDIWw==')

WebUI.click(findTestObject('Object Repository/Login-01/Page_1 new message/button_Log in'))
