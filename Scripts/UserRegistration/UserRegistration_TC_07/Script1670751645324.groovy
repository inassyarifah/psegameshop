...
WebUI.selectOptionByValue(findTestObject('Page_Form Register/select_favoriteGenre'), 'Music', 
    true)
...
WebUI.verifyElementText(findTestObject('Object Repository/Alert/div_Alert_Error An account is already registered'), 
